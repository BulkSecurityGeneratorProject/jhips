    ...
    describe('Household Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/households';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Household', () => {
                service.create(new Household(null)).subscribe(received => {
            ...
            it('should update a Household', () => {
                service.update(new Household(123)).subscribe(received => {
