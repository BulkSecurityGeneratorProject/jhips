    ...
    describe('Market Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Market', () => {
                service.create(new Market(null)).subscribe(received => {
            ...
            it('should update a Market', () => {
                service.update(new Market(123)).subscribe(received => {
            ...
            it('should return a list of Market', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Market(123)]);
            });
