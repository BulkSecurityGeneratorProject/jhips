    ...
    describe('Purchase Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/purchases';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Purchase', () => {
                service.create(new Purchase(null)).subscribe(received => {
            ...
            it('should update a Purchase', () => {
                service.update(new Purchase(123)).subscribe(received => {
