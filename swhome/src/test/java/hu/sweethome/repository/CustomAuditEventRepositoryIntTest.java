...
import hu.sweethome.config.audit.AuditEventConverter;
import hu.sweethome.domain.PersistentAuditEvent;
...
import static hu.sweethome.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
